...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Flyway Migration'.
...
This project has been configured to let you generate a lightweight container running a native executable. Docker should be
installed and configured on your machine prior to creating the image,
...
```bash
docker run --rm -p 8080:8080 spring-data-jpa-postgres-json:0.0.1-SNAPSHOT
```
